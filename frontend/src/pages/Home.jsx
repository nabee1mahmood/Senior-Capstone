    ...
    <div className={`dashboard ${darkMode ? "dark" : "light"}`}>
      ...
      <header className="dashboard-header d-flex justify-content-between align-items-center mb-4">
        ...
        <div className="position-relative">
          ...
          {menuOpen && (
            <div className="card shadow-sm position-absolute"
          ...
          <div className="card shadow-sm h-100">
            ...
            <div className="d-flex align-items-end w-100" style={{ height: 160, gap: "6px", padding: "8px" }}>
              {data.map((h, i) => (
                ...
                >
                  <span style={{ color: "white", fontWeight: "bold", fontSize: "0.8rem", marginBottom: 2 }}>
                    {h}
                  </span>
                </div>
              ))}
          ...
          <div className="card shadow-sm h-100">
            ...
            <div className="card-body" style={{ minHeight: 200 }}>
              <ul className="list-unstyled mb-0">
                <li className="d-flex justify-content-between py-2 border-bottom"><span>Temperature</span><span className="font-weight-medium">5</span></li>
                <li className="d-flex justify-content-between py-2 border-bottom"><span>Motion</span><span className="font-weight-medium">2</span></li>
                <li className="d-flex justify-content-between py-2"><span>Door / Window</span><span className="font-weight-medium">1</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="recent-activity">
        <div className="card shadow-sm">
          ...
          <div className="card-body">
            <p className="text-muted small mb-0">Living Room Sensor — 72°F · 2 min ago</p>
            <p className="text-muted small mb-0 mt-2">Front Door — Opened · 15 min ago</p>
            <p className="text-muted small mb-0 mt-2">Kitchen — Motion Detected · 1 hr ago</p>
          </div>
        </div>
      </section>
    </div>
